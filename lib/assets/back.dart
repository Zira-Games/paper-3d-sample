...
class BackAsset extends WorldAsset {
  ...
  BackAsset(String id, ScreenSize screenSize, TickerManager tickerManager) : super(
      controller: DefaultAssetController<BackAssetModel>(
          BackAssetModel(id, screenSize),
          tickerManager,
...
class BackAssetModel extends WorldAssetModel {
  ...
  BackAssetModel(String id, ScreenSize screenSize) : super(
      id,
      screenSize,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        color: Colors.yellow,
        child: const Center(
          child: Text("2", style: TextStyle(color: Colors.white, fontSize: 200, decoration: TextDecoration.none)),
        )
      )
    );
  }
